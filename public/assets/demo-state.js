// Embedded default state for the serverless (GitHub Pages) demo.
// Mirrors DEFAULT_STATE in server.js so the overlays/dashboard have content
// with no /api/state fetch and no WebSocket hub. Keep these two in sync.
const DEMO_STATE = {
  layout: 'solo',
  theme: 'gemini',
  ...
  speakers: [
    ...
    },
    {
      ...
      social: '@alex_codes',
      badges: ['typescript', 'nodejs', 'tensorflow', 'github'],
...
// Expose globally for non-module scripts, mirroring the icons.js/synth.js pattern.
